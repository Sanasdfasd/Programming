...
void node::select_best_attribute(vector<int> &attr_list,vector<int>& que, vector<int> & path,int index,int convert,int& break_cond,float ent)
{
	...
	if(str_tota1==0 || str_tota2==0)
	{
		...
		/*if(str_tota2==0)
		{
			this->pos_inst=str_pos1;
	     	this->neg_inst=str_neg1;
		}*/
	//	cout<<"iam here plesae please"<<endl;
		 break_cond=1;
		 //return;
	}
...
//cout <<endl;
	if(attr.size()==0)
	{
		...
		// cout<<"postive inst"<<nt->pos_inst<<"negitive"<<nt->neg_inst<<endl;
	...
	{
		//nt->predictive_class=0;
		//cout<<"postive inst"<<r->pos_inst<<"negitive"<<r->neg->inst<<endl;
...
int main()
{
 ...
 //  infile>>test_cases;
  ...
  int i=0,j;
   ...
   cout<<endl;
   cout <<"training_Leaf_nodes: "<<training_leafnodes<<endl<<"training_internalnodes:  "<<training_internalnodes+training_leafnodes-1<<endl;
